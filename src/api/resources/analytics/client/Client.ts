...
export class Analytics {
    ...
    private async __getConversationTable(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.ConversationTableResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __getConversationChart(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.ChartResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __getFeedbackTable(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.FeedbackTableResponse, rawResponse: _response.rawResponse };
        }
