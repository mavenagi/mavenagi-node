...
export class Agents {
    ...
    private async __search(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.AgentsSearchResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __list(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.Agent[], rawResponse: _response.rawResponse };
        }
