...
export class AgentCapabilities {
    ...
    public execute(
        ...
        requestOptions?: AgentCapabilities.RequestOptions,
    ): core.HttpResponsePromise<MavenAGI.ExecuteCapabilityResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__execute(integrationId, capabilityId, request, requestOptions),
        );
    }
    ...
    private async __execute(
        ...
        request: MavenAGI.ExecuteCapabilityRequest,
        requestOptions?: AgentCapabilities.RequestOptions,
    ): Promise<core.WithRawResponse<MavenAGI.ExecuteCapabilityResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/integrations/${encodeURIComponent(integrationId)}/capabilities/${encodeURIComponent(capabilityId)}/execute`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MavenAGITimeoutError(
                    "Timeout exceeded when calling POST /v1/integrations/{integrationId}/capabilities/{capabilityId}/execute.",
                );
            case "unknown":
                throw new errors.MavenAGIError({
                    message: _response.error.errorMessage,
