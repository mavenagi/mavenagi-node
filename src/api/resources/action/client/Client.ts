...
export class Action {
    constructor(protected readonly _options: Action.Options) {}
     ...
     */
    public async get(actionId: string, requestOptions?: Action.RequestOptions): Promise<MavenAGI.Action> {
     ...
     *     })
     */
    public async register(request: MavenAGI.Action, requestOptions?: Action.RequestOptions): Promise<MavenAGI.Action> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MavenAGIEnvironment.Production,
                "/v1/actions"
     ...
     */
    public async delete(actionId: string, requestOptions?: Action.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.MavenAGIEnvironment.Production,
                `/v1/actions/${encodeURIComponent(actionId)}`
