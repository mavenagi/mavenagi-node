...
export class Inbox {
    ...
    private async __search(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.InboxSearchResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        _queryParams["itemType"] = itemType;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.InboxItem, rawResponse: _response.rawResponse };
        }
    ...
    private async __getFix(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.InboxItemFix, rawResponse: _response.rawResponse };
        }
