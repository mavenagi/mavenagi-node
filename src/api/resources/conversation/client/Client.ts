...
export class Conversation {
    ...
    private async __initialize(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.ConversationResponse, rawResponse: _response.rawResponse };
        }
     ...
     *     })
     */
    public generateMavenSuggestions(
        conversationId: string,
        request: MavenAGI.GenerateMavenSuggestionsRequest,
        requestOptions?: Conversation.RequestOptions,
    ): core.HttpResponsePromise<MavenAGI.ConversationResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__generateMavenSuggestions(conversationId, request, requestOptions),
        );
    }

    private async __generateMavenSuggestions(
        conversationId: string,
        request: MavenAGI.GenerateMavenSuggestionsRequest,
        requestOptions?: Conversation.RequestOptions,
    ): Promise<core.WithRawResponse<MavenAGI.ConversationResponse>> {
    ...
    private async __categorize(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.CategorizationResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __createFeedback(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.Feedback, rawResponse: _response.rawResponse };
        }
    ...
    private async __updateConversationMetadata(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.ConversationMetadata, rawResponse: _response.rawResponse };
        }
    ...
    private async __search(
        ...
        if (_response.ok) {
            return { data: _response.body as MavenAGI.ConversationsResponse, rawResponse: _response.rawResponse };
        }
