...
export declare namespace ConversationClient {
...
export class ConversationClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ConversationClient.Options>;

    constructor(options: ConversationClient.Options) {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/conversations/${core.url.encodePathParam(conversationId)}/ask`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    private async __askStream(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)<ReadableStream>({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/conversations/${core.url.encodePathParam(conversationId)}/ask_stream`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/v1/conversations/{conversationId}/ask_stream",
        );
    }
    ...
    private async __categorize(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/conversations/${core.url.encodePathParam(conversationId)}/categorize`,
            ),
            method: "POST",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/v1/conversations/{conversationId}/categorize",
        );
    }
    ...
    private async __createFeedback(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/conversations/feedback");
    }
    ...
    private async __submitActionForm(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/conversations/${core.url.encodePathParam(conversationId)}/submit-form`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/v1/conversations/{conversationId}/submit-form",
        );
    }
    ...
    private async __addConversationMetadata(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MavenAGIEnvironment.Production,
                `/v1/conversations/${core.url.encodePathParam(conversationId)}/metadata`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/v1/conversations/{conversationId}/metadata",
        );
    }
    ...
    private async __export(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/conversations/export");
    }
    ...
    private async __importSimulations(
        ...
        if (request.responseConfig != null) {
            _body.append(
                "responseConfig",
                toJson(
                    serializers.ResponseConfig.jsonOrThrow(request.responseConfig, { unrecognizedObjectKeys: "strip" }),
                ),
            );
        }
